...
![Early version of my Easy to build Quadcopter.]({{ site.url }}/images/post_images/copter test.png) {: .pull-right}
...
![Wombat holding down the Quadcopter.]({{ site.url }}/images/post_images/Wombatcopter.png) {: .pull-right}
